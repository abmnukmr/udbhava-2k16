...
public class Electronics extends Fragment {
    ...
    public static Electronics newInstance() {
        Electronics fragment5 = new Electronics();
        return fragment5;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview=inflater.inflate(R.layout.fragment_electronics, container, false);

        mRef = FirebaseDatabase.getInstance().getReference().child("Events").child("ece").child("events");



        RecyclerView rcl =(RecyclerView)mview.findViewById(R.id.eventsrecycelviewelectronics);
    ...
    public static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        public ChatHolder(View itemView) {
            ...
            mReef=FirebaseDatabase.getInstance().getReference().child("Events").child("ece").child("Reg");
