 ...
 */
public class Funpage extends Fragment {
    ...
    public static Funpage newInstance() {
        Funpage fragment5 = new Funpage();
        return fragment5;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         View mview=inflater.inflate(R.layout.fragment_funpage, container, false);

        mRef = FirebaseDatabase.getInstance().getReference().child("Events").child("fun").child("events");



        RecyclerView rcl =(RecyclerView)mview.findViewById(R.id.eventsrecycelviewfunpage);
    ...
    public static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        public ChatHolder(View itemView) {
            ...
            mReef=FirebaseDatabase.getInstance().getReference().child("Events").child("fun").child("Reg");
