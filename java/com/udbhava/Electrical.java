...
public class Electrical extends Fragment {
    ...
    public static Electrical newInstance() {
        Electrical fragment5 = new Electrical();
        return fragment5;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview=inflater.inflate(R.layout.fragment_electrical, container, false);
        mRef = FirebaseDatabase.getInstance().getReference().child("Events").child("eee").child("events");



        RecyclerView rcl =(RecyclerView)mview.findViewById(R.id.eventsrecycelviewee);
    ...
    public static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        public ChatHolder(View itemView) {
            ...
            mReef=FirebaseDatabase.getInstance().getReference().child("Events").child("eee").child("Reg");
