 ...
 */
public class Litrery extends Fragment {
    ...
    public static Litrery newInstance() {
        Litrery fragment5 = new Litrery();
        return fragment5;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview = inflater.inflate(R.layout.fragment_litrery, container, false);

        mRef = FirebaseDatabase.getInstance().getReference().child("Events").child("lit").child("events");



        RecyclerView rcl =(RecyclerView)mview.findViewById(R.id.eventsrecycelviewlit);
    ...
    public static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        public ChatHolder(View itemView) {
            ...
            mReef=FirebaseDatabase.getInstance().getReference().child("Events").child("lit").child("Reg");
