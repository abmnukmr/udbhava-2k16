...
public class Civildepartment extends Fragment {
    ...
    public static Civildepartment newInstance() {
        Civildepartment fragment5 = new Civildepartment();
        return fragment5;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview=inflater.inflate(R.layout.fragment_civildepartment, container, false);


        mRef = FirebaseDatabase.getInstance().getReference().child("Events").child("ced").child("events");



        RecyclerView rcl =(RecyclerView)mview.findViewById(R.id.eventsrecycelviewcivildepartment);
        final ProgressBar progressBar=(ProgressBar)mview.findViewById(R.id.progressbarcivill);
    ...
    public static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        public ChatHolder(View itemView) {
            ...
            mReef=FirebaseDatabase.getInstance().getReference().child("Events").child("ced").child("Reg");
