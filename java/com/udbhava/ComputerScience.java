...
public class ComputerScience extends Fragment {
    ...
    public static  ComputerScience newInstance() {
        ComputerScience fragment5 = new  ComputerScience();
        return fragment5;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mview=inflater.inflate(R.layout.fragment_computer_science, container, false);

        mRef = FirebaseDatabase.getInstance().getReference().child("Events").child("cse").child("events");



        RecyclerView rcl =(RecyclerView)mview.findViewById(R.id.eventsrecycelviewcomputerscience);
    ...
    public static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        public ChatHolder(View itemView) {
            ...
            mReef=FirebaseDatabase.getInstance().getReference().child("Events").child("cse").child("Reg");
