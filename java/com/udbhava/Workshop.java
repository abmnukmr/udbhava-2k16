...
public class Workshop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        mRef = FirebaseDatabase.getInstance().getReference().child("workshop").child("wrk");



        RecyclerView rcl =(RecyclerView)findViewById(R.id.eventsrecycelviewworkshop);
        ...
        mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ProgressBar progressBar=(ProgressBar)findViewById(R.id.progressarworkshop);
        ...
        mRecycleViewAdapter = new FirebaseRecyclerAdapter<Post, ChatHolder>(Post.class, R.layout.workshopelement, ChatHolder.class, mRef) {
            @Override
            protected void populateViewHolder(ChatHolder chatHolder, Post post, int i) {
                ...
                chatHolder.setTitle(post.getPaylink());
    ...
    public static class Post {
        ...
        public Post(String about, String contact, String image1, String image2,String image3,String paylink,String title,String titleimg/*String college,String email,String eventname, String members,String phone, String teamname*/) {
            this.about =about;
    ...
    public static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        public ChatHolder(View itemView) {
            ...
            mReef=FirebaseDatabase.getInstance().getReference().child("workshop").child("Reg");
            ...
            register.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (cg.equals("")||em.equals("")||eve.equals("")||mem.equals("")||ph.equals("")||tem.equals("")){
                        ...
                        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(paylink));
